...
public interface OrdersMapper {
    @Mapping(source = "ordersCustomer", target = "customer")
    ...
    @Mapping(source = "customer", target = "ordersCustomer")
    ...
    List<OrdersDto> fromEntityListToOrdersDtoList(List<Orders> orderss);
}
